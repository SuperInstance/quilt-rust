#![allow(clippy::missing_safety_doc)] // C ABI: pointer-validity contract documented at module level
...
#[no_mangle]
pub unsafe extern "C" fn quilt_engine_load_sheet(
...
#[no_mangle]
pub unsafe extern "C" fn quilt_engine_get(
    engine: *mut QuiltEngine,
